...
class LoxCustomLexer(NeutronLexer):
    """Custom lexer for lox"""

    def __init__(self, editor):
        super(LoxCustomLexer, self).__init__("PyLox", editor)

        self.setKeywords(keyword.kwlist)
        self.setKeywords(["var"])
    ...
    def styleText(self, start: int, end: int) -> None:
        ...
        if start > 0:
            prev_style = self.editor.SendScintilla(
        ...
        while True:
            ...
            if tok == "class":
                ...
                if self.peek_tok()[0] == "(":
                    ...
                    self.setStyling(tok_len, self.DEFAULT)
                continue
            elif tok.isnumeric() or tok == "this":
